...
import { Plus, Sliders, Calendar, Search, Eye, Edit, Trash2, Download } from "lucide-react";
import Link from "next/link";
import { useState } from "react";

const initialCreditNotes = [
  { id: 1, number: "CN-001", client: "Acme Corp", amount: "$500.00", date: "2026-05-01", status: "Open" },
  { id: 2, number: "CN-002", client: "Globex Corp", amount: "$1,200.00", date: "2026-05-03", status: "Closed" },
];
                ...
                <tr key={note.id} className="hover:bg-gray-50 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button className="p-2 hover:bg-indigo-50 text-gray-400 hover:text-indigo-500 rounded transition-all" title="Download">
