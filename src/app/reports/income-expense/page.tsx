...
const stats = [
  { label: "Total Income", value: "$45,000.00", color: "text-green-500", icon: TrendingUp, bg: "bg-green-50" },
  { label: "Total Expense", value: "$12,400.00", color: "text-red-500", icon: TrendingDown, bg: "bg-red-50" },
  { label: "Total Profit", value: "$32,600.00", color: "text-blue-500", icon: DollarSign, bg: "bg-blue-50" },
];
        ...
        <Card className="border-none shadow-sm p-6 bg-white mb-6">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-4">
              ...
              <select className="w-full bg-gray-50/50 border-none rounded-xl py-3 px-4 text-xs font-bold focus:ring-2 focus:ring-primary/20 outline-none appearance-none cursor-pointer">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tfoot className="bg-gray-50/50 font-black border-t border-gray-100">
                <tr>
                  ...
                  <td className="px-8 py-5 text-xs text-green-600 text-right tracking-tight">$45,500</td>
                  <td className="px-8 py-5 text-xs text-red-500 text-right tracking-tight">$15,400</td>
                  <td className="px-8 py-5 text-xs text-blue-600 text-right tracking-tight">$30,100</td>
                </tr>
              </tfoot>
            </table>
          </div>
